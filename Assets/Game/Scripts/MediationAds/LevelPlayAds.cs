...
public class LevelPlayAds : MonoBehaviour
{
...
#if UNITY_ANDROID
      appKey = "20e56aea5";
      bannerAdUnitId = "yhyb1cucflyobepc";
      interstitialAdUnitId = "tgs5md7s309shsf1";
#elif UNITY_IOS
      appKey = "201621875";
  ...
  void SdkInitializationCompletedEvent(Unity.Services.LevelPlay.LevelPlayConfiguration config)
  {
    ...
    if (!GameManager.Instance.IsRemoveAds
      && !GameManager.Instance.IsRemoveAds7d)
    {
      bannerAd.LoadAd();
  ...
  void RewardedVideoOnAdClosedEvent(IronSourceAdInfo adInfo)
  {
    ...
    if (_isSucceed)
    {
      ...
      Utility.Print("Level_" + (GameManager.Instance.CurrentLevel + 1) + "Stage_" + stage + "_Placement_" + _placementRewardAds);
    }
    else
    {
    ...
    Action fallback = null)
  {
    ...
    if (interstitialAd.IsAdReady())
    {
      ...
      Utility.Print("Ads_inter_show" + GameManager.Instance.CurrentLevel + 1);
    }
    else
    {
      BackToNormal();
